...
class Pool:
    ...
    """
    __slots__ = ...
    def __init__(self, *connect_args, min_size, max_size, max_queries, max_inactive_connection_lifetime, connect=..., setup=..., init=..., reset=..., loop, connection_class, record_class, **connect_kwargs) -> None:
        ...
    ...
    async def copy_to_table(self, table_name, *, source, columns=..., schema_name=..., timeout=..., format=..., oids=..., freeze=..., delimiter=..., null=..., header=..., quote=..., escape=..., force_quote=..., force_not_null=..., force_null=..., encoding=..., where=...):
    ...
    async def copy_records_to_table(self, table_name, *, records, columns=..., schema_name=..., timeout=..., where=...):
...
def create_pool(dsn=..., *, min_size=..., max_size=..., max_queries=..., max_inactive_connection_lifetime=..., connect=..., setup=..., init=..., reset=..., loop=..., connection_class=..., record_class=..., **connect_kwargs): # -> Pool:
