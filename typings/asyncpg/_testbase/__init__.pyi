...
class TestCase(unittest.TestCase, metaclass=TestCaseMeta):
    ...
    @contextlib.contextmanager
    def assertLoopErrorHandlerCalled(self, msg_re: str): # -> Generator[None, Any, None]:
        ...
...
_default_cluster = ...
def create_pool(dsn=..., *, min_size=..., max_size=..., max_queries=..., max_inactive_connection_lifetime=..., connect=..., setup=..., init=..., loop=..., pool_class=..., connection_class=..., record_class=..., **connect_kwargs): # -> Pool:
    ...
...
class HotStandbyTestCase(ClusterTestCase):
    ...
    @classmethod
    def connect_primary(cls, **kwargs): # -> Coroutine[Any, Any, Any]:
        ...

    @classmethod
    def connect_standby(cls, **kwargs): # -> Coroutine[Any, Any, Any]:
        ...
