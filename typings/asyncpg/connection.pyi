...
async def connect(dsn=..., *, host=..., port=..., user=..., password=..., passfile=..., database=..., loop=..., timeout=..., statement_cache_size=..., max_cached_statement_lifetime=..., max_cacheable_statement_size=..., command_timeout=..., ssl=..., direct_tls=..., connection_class=..., record_class=..., server_settings=..., target_session_attrs=..., krbsrvname=..., gsslib=...):
