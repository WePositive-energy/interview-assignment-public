...
_PreparedStatementState = TypeVar('_PreparedStatementState', bound=PreparedStatementState[Any])
...
class ConnectionSettings(asyncpg.pgproto.pgproto.CodecContext):
    ...
    def add_python_codec(self, typeoid: int, typename: str, typeschema: str, typeinfos: Iterable[object], typekind: str, encoder: Callable[[Any], Any], decoder: Callable[[Any], Any], format: object) -> Any:
        ...

    def clear_type_cache(self) -> None:
        ...

    def get_data_codec(self, oid: int, format: object = ..., ignore_custom_codec: bool = ...) -> Any:
        ...
    ...
    def remove_python_codec(self, typeoid: int, typename: str, typeschema: str) -> None:
        ...

    def set_builtin_type_codec(self, typeoid: int, typename: str, typeschema: str, typekind: str, alias_to: str, format: object = ...) -> Any:
        ...
...
class PreparedStatementState(Generic[_Record]):
    ...
    __pyx_vtable__: Any
    def __init__(self, name: str, query: str, protocol: BaseProtocol[Any], record_class: type[_Record], ignore_custom_codec: bool) -> None:
        ...
...
class BaseProtocol(CoreProtocol, Generic[_Record]):
    ...
    is_ssl: bool
    __pyx_vtable__: Any
    def __init__(self, addr: object, connected_fut: object, con_params: _ConnectionParameters, record_class: type[_Record], loop: object) -> None:
        ...
    ...
    async def bind(self, state: PreparedStatementState[_OtherRecord], args: Sequence[object], portal_name: str, timeout: _TimeoutType) -> Any:
        ...

    @overload
    async def bind_execute(self, state: PreparedStatementState[_OtherRecord], args: Sequence[object], portal_name: str, limit: int, return_extra: Literal[False], timeout: _TimeoutType) -> list[_OtherRecord]:
        ...

    @overload
    async def bind_execute(self, state: PreparedStatementState[_OtherRecord], args: Sequence[object], portal_name: str, limit: int, return_extra: Literal[True], timeout: _TimeoutType) -> tuple[list[_OtherRecord], bytes, bool]:
        ...

    @overload
    async def bind_execute(self, state: PreparedStatementState[_OtherRecord], args: Sequence[object], portal_name: str, limit: int, return_extra: bool, timeout: _TimeoutType) -> list[_OtherRecord] | tuple[list[_OtherRecord], bytes, bool]:
        ...

    async def bind_execute_many(self, state: PreparedStatementState[_OtherRecord], args: Iterable[Sequence[object]], portal_name: str, timeout: _TimeoutType) -> None:
        ...

    async def close(self, timeout: _TimeoutType) -> None:
        ...

    async def close_statement(self, state: PreparedStatementState[_OtherRecord], timeout: _TimeoutType) -> Any:
        ...
    ...
    @overload
    async def prepare(self, stmt_name: str, query: str, timeout: float | None = ..., *, state: _PreparedStatementState, ignore_custom_codec: bool = ..., record_class: None) -> _PreparedStatementState:
        ...

    @overload
    async def prepare(self, stmt_name: str, query: str, timeout: float | None = ..., *, state: None = ..., ignore_custom_codec: bool = ..., record_class: type[_OtherRecord]) -> PreparedStatementState[_OtherRecord]:
        ...
...
class DataCodecConfig:
    ...
    def add_python_codec(self, typeoid: int, typename: str, typeschema: str, typekind: str, typeinfos: Iterable[object], encoder: Callable[[ConnectionSettings, WriteBuffer, object], object], decoder: Callable[..., object], format: object, xformat: object) -> Any:
        ...
    ...
    def remove_python_codec(self, typeoid: int, typename: str, typeschema: str) -> Any:
        ...
